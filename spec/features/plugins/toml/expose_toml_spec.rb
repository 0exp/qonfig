...
describe 'Plugins(toml): expose TOML file', :plugin do
  ...
  specify 'defines config object by toml instructions and specific environment settings' do
    class ExposeTOMLConfig < Qonfig::DataSet
      toml_file_path = SpecSupport.fixture_path('expose_toml', 'project.toml')

      setting :file_name_based do
        setting :test_env do
          # spec/fixtures/expose_toml/project.test.toml
          expose_toml toml_file_path, via: :file_name, env: :test
        end

        setting :prod_env do
          # spec/fixtures/expose_toml/project.production.toml
          expose_toml toml_file_path, via: :file_name, env: :production
        end

        setting :stage_env do
          # spec/fixtures/expose_toml/project.staging.toml
          expose_toml toml_file_path, via: :file_name, env: :staging
        end

        setting :dev_env do
          # spec/fixtures/expose_toml/project.development.yml
      ...
      setting :env_based do
        setting :test_env do
          # spec/fixtures/expose_toml/project.toml
    ...
    # spec/fixtures/expose_toml/project.development.toml
    ...
    # spec/fixtures/expose_toml/projecttoml (table: 'test')
    ...
    # spec/fixtures/expose_toml/project.toml (table: 'production')
    ...
    # spec/fixtures/expose_toml/projecttoml (table: 'development')
    ...
    # spec/fixtures/expose_toml/projecttoml (table: 'staging')
    ...
    describe 'initialization level errors' do
      describe 'strict mode' do
        ...
        specify(
          ...
          #   - file: spec/fixtures/expose_toml/project.toml
