...
describe '.values_file / #load_from_self (with __END__ data) (JSON format)' do
  describe 'DSL macros' do
    ...
    specify 'loads setting values from __END__ defined as JSON instructions' do
  ...
  describe 'Instance method' do
    ...
    specify 'loads setting values from __END__ defined as JSON instructions' do
      ...
      config.load_from_self(format: :json)
